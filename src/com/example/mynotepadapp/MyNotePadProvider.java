...
import com.example.mynotepadapp.MyNotePad.NoteColumns;
 ...
 */
public class MyNotePadProvider extends ContentProvider {

    private static final String TAG = "MyNotePadProvider";
    ...
    static {
        ...
        sUriMatcher.addURI(MyNotePad.AUTHORITY, "notes", NOTES);
        sUriMatcher.addURI(MyNotePad.AUTHORITY, "notes/#", NOTE_ID);
        sUriMatcher.addURI(MyNotePad.AUTHORITY, "live_folders/notes", LIVE_FOLDER_NOTES);
