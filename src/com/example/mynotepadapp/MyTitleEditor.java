 ...
 */
public class MyTitleEditor extends Activity implements View.OnClickListener {

    /**
     * This is a special intent action that means "edit the title of a note".
     */
    public static final String EDIT_TITLE_ACTION = "com.example.mynotepadapp.action.EDIT_TITLE";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_title_editor);
